...
public:
    HorizontalSlider(int minValue, int maxValue, int width, int height, sf::Font font);
    
    void onChange(std::function<void(double)> changeCallback) {m_changeCallback = changeCallback;};
