        ...
        if char == as_char("{") {
            ...
            if blocks_open > 1 { blocks_open -= 1 }
                ...
                if block_type_str == fixture_tag {
                    ...
                    //let channel_groups: Vec<ChannelGroup> = Vec::new();
                    ...
                    // block_to_commands(block).into_iter().map(|command| {
                        ...
                        // let mut name = "";
                        // command.char_indices().map(|(index, char)| {
                        //     if command_open > 0 {
                    ...
                    // }).collect::<Vec<_>>();
                    //TODO: Assemble fixture preset out of channel groups
                    //fixtures.push(block_to_commands(block));
